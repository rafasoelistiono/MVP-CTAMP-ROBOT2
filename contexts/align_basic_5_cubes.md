# CONTEXT.MD - Basic 5 Cubes Alignment Without Obstacles

## scene
- scene_id: align_basic_5_cubes
- variant: ungroup_no_obs
...
- description: Susun lima cube menjadi satu baris sepanjang sumbu X pada goal area.
